...
const Checkout = () => {
  ...
  const [form, setForm] = useState<Record<string, string>>({
    name: "", email: "", phone: "", address: "", city: "", state: "", order_notes: "",
  });
    ...
    try {
      ...
      if (typeof (window as any).PaystackPop !== "undefined" || document.querySelector('script[src*="paystack"]')) {
        const handler = (window as any).PaystackPop.setup({
          ...paystackConfig,
          onClose: () => { setLoading(false); toast.info("Payment window closed."); },
  ...
  const fieldPlaceholders: Record<string, string> = {
    name: "Full name", email: "you@example.com", phone: "08012345678",
    address: "Street address", city: "Lagos", state: "Lagos State",
        ...
        <div className="lg:col-span-2">
          <Card className="sticky top-24">
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="w-full volt-gradient h-12 text-base" onClick={handleSubmit} disabled={loading}>
